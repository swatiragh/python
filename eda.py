...
train = pd.read_csv('/Users/swatiraghav/Documents/sample/walmart-sales-forecasting-main/train.csv')
test = pd.read_csv('/Users/swatiraghav/Documents/sample/walmart-sales-forecasting-main/test.csv')
store = pd.read_csv('/Users/swatiraghav/Documents/sample/walmart-sales-forecasting-main/stores.csv')
feature = pd.read_csv('/Users/swatiraghav/Documents/sample/walmart-sales-forecasting-main/features.csv')
...
plt.plot(walmartstoredf[(walmartstoredf.Store == 1)].Week, walmartstoredf[(walmartstoredf.Store == 1)].Weekly_Sales,
         'ro')
plt.show()
